...
run_name="qwen3_vl_dit"
output_dir=./outputs/T_0203/stage1-r2r+rxr-freeze_vision-lr_${lr}-batch_size_${batch_size}-grad_accum_steps_${grad_accum_steps}-epochs_${num_train_epochs}-tune_mm_llm_${tune_mm_llm}
