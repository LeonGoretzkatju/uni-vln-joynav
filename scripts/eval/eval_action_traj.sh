...
#**************************************************
# @date: 2026-02-06
# @func: eval vlm+mlp model;
#        bash scripts/eval/eval_action_traj.sh
#**************************************************
...
EVAL_TYPE=qwen3_vl_cont

# MODEL_PATH="/mnt/workspace/users/zhaolin/vln/code/develop/JD-VLN/outputs/T_0205_zl/" 
MODEL_PATH="outputs/T_0205_zl/stage1-r2r+rxr-freeze_vision-lr_2e-5-batch_size_1-grad_accum_steps_8-epochs_1-tune_mm_llm_true"
OUTPUT_PATH="results/T_0205_zl_cont_test/stage1-r2r+rxr-freeze_vision-lr_2e-5-batch_size_1-grad_accum_steps_8-epochs_1-tune_mm_llm_true"
