...
MODEL_TYPE=${MODEL_TYPE:-qwen3_5_nextdit_head_sf_omega}
EVALUATOR_TYPE=${EVALUATOR_TYPE:-qwen3_5_nextdit_head_sf_omega}
MODEL_PATH=${MODEL_PATH:-outputs/qwen3_5_0_8b_sf_omega_nextdit_traj}
OUTPUT_PATH=${OUTPUT_PATH:-results/r2r/val_unseen/qwen3_5_sf_omega_nextdit_traj}
