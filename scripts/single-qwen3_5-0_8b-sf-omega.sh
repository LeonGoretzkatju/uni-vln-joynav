...
pip install flash_attn-2.7.3+cu11torch2.6cxx11abiFALSE-cp310-cp310-linux_x86_64.whl
...
case "${omega_mode}" in
  ...
  text_align)
    ...
    ;;
  *)
    echo "Unsupported OMEGA_MODE: ${omega_mode}. Use 512_1b or text_align." >&2
    exit 1
    ;;
esac
...
run_name=${RUN_NAME:-"qwen3_5_0_8b_full_sf_omega_fp"}
