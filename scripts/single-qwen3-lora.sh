...
NNODES=${WORLD_SIZE:-1}
NPROC_PER_NODE=3  # 3x 4090/3090/TITAN GPUs
...
# Model configuration
llm=/mnt/nas5/xiangchen/vlm_base/Qwen3-VL-4B-Instruct
...
run_name="qwen3_vl_lora"
output_dir=./outputs/${run_name}/stage1-r2r+rxr-lora_r${lora_r}-lr_${lr}-mm_lr_${mm_projector_lr}-batch_size_${batch_size}-grad_accum_steps_${grad_accum_steps}-epochs_${num_train_epochs}
...
# Launch training
CUDA_VISIBLE_DEVICES=0,1,3 torchrun --nproc_per_node=${NPROC_PER_NODE} \
