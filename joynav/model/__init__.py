...
from .qwen3_vl_lm_head_dyna import JoyNav_Qwen3VLDynamicRopeForCausalLM
...
register_component("model", "qwen3_vl_lm_head_dyna", JoyNav_Qwen3VLDynamicRopeForCausalLM)
