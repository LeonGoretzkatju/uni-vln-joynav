...
from .qwen3_vl_dit import JoyNav_Qwen3VLDiTForCausalLM
from .qwen3_vl_action import JoyNav_Qwen3VLActionForCausalLM
...
register_component("model", "qwen3_vl_dit", JoyNav_Qwen3VLDiTForCausalLM)
register_component("model", "qwen3_vl_action", JoyNav_Qwen3VLActionForCausalLM)