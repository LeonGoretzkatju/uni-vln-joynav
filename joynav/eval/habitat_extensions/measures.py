...
class NDTW(Measure):
    ...
    def __init__(
        ...
        # This is a hardcoded path. A better solution would be to make it configurable.
        # BUUUUUUTTTTT, making it configurable you have to change the habitat-lab code
        # which is really complicated (check this /habitat-lab-0.2.4/habitat-lab/habitat/config/default_structured_configs.py)
        # if "gt_path" not in self._config:
        #     raise ValueError("gt_path not found in config")
        # else:
        #     self.gt_path = self._config.get("gt_path")
